...
$files = [
    "app/views/estudante/recibo_print.php" => "/htdocs/app/views/estudante/recibo_print.php",
    "app/views/estudante/recibo_matricula_print.php" => "/htdocs/app/views/estudante/recibo_matricula_print.php"
];
